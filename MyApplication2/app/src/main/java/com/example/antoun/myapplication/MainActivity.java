...
public class MainActivity extends ActionBarActivity {
    ...
    protected EditText emailname;

    private EditText password;
    private String enteredPassword;
    protected String enteredemail;

    private final String serverUrl = "http://192.168.1.1/android_user_api/index.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailname = (EditText)findViewById(R.id.email_field);
...
//        Button registerButton = (Button)findViewById(R.id.register_button);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                enteredemail = emailname.getText().toString();
